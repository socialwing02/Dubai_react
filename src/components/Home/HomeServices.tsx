...
export default function HomeServices() {
  return (
    <section className="grid grid-cols-1  sm:grid-cols-[repeat(3,290px)] gap-10 justify-center  my-10 max-w-[1200px] mx-auto px-8  ">
  ...
  return (
    <>
      <div className="service-card  text-center bg-[#171717] text-white  flex flex-col gap-3 items-center shadow-lg  p-6 rounded-xl">
        <props.icon sx={{ color: "#960215", fontSize: "4rem" }} />
